...
@Component({
  selector: 'UserFeedback-home',
  templateUrl: './UserFeedback-home.component.html',
  styleUrls: ['./UserFeedback-home.component.scss']
})
export class UserFeedbackHomeComponent implements AfterViewInit {
