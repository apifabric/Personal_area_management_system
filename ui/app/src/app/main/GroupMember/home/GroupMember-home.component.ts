...
@Component({
  selector: 'GroupMember-home',
  templateUrl: './GroupMember-home.component.html',
  styleUrls: ['./GroupMember-home.component.scss']
})
export class GroupMemberHomeComponent implements AfterViewInit {
