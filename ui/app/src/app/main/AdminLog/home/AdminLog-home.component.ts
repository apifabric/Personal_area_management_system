...
@Component({
  selector: 'AdminLog-home',
  templateUrl: './AdminLog-home.component.html',
  styleUrls: ['./AdminLog-home.component.scss']
})
export class AdminLogHomeComponent implements AfterViewInit {
