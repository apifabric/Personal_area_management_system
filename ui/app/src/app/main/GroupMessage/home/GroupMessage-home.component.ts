...
@Component({
  selector: 'GroupMessage-home',
  templateUrl: './GroupMessage-home.component.html',
  styleUrls: ['./GroupMessage-home.component.scss']
})
export class GroupMessageHomeComponent implements AfterViewInit {
