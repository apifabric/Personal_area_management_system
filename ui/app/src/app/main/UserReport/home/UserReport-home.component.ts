...
@Component({
  selector: 'UserReport-home',
  templateUrl: './UserReport-home.component.html',
  styleUrls: ['./UserReport-home.component.scss']
})
export class UserReportHomeComponent implements AfterViewInit {
