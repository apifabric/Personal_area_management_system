...
resourcename="personalareamanagementsystem"  # lower case, only
resourcegroup="personalareamanagementsystem_rg"
...
# git clone https://github.com/apilogicserver/personalareamanagementsystem.git
# cd personalareamanagementsystem
...
az group create --name personalareamanagementsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group personalareamanagementsystem_rg --sku S1 --is-linux
az container create --resource-group personalareamanagementsystem_rg --name personalareamanagementsystem --image apilogicserver/personalareamanagementsystem:latest --dns-name-label personalareamanagementsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//personalareamanagementsystem.westus.azurecontainer.io:5656'
